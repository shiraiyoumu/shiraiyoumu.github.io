const menu = [
    ...
    { menu: "ソース塩焼きそば", price:1000 ,shop:"M&M" },
    { menu: "佐世保バーガー", price:1200 ,shop:"金井牧場" },    
    { menu: "キムチチヂミ", price:1300 ,shop:"キッチンカーまろん" },
    { menu: "THE素麺", price:800 ,shop:"そうめん専門甚-JIN-" },
    { menu: "SPICY　SOY　MEAT", price:800 ,shop:"rachienpotato" },  
    { menu: "蛇口からみかんジュース", price:500 ,shop:"EHIMEみきゃんずキッチン" }, 
    { menu: "牛たたきと帆立丼", price:1200 ,shop:"宗谷岬間宮堂" },    
    { menu: "下北沢ミートサンドダブル", price:1900 ,shop:"STABLER Shimokitazawa Meatsand" },   
    { menu: "本格うな重", price:2500 ,shop:"うなぎのまんまる" },    
